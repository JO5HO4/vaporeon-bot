...
Every Tide Duel move is available regardless of affection. Each player begins at 100 HP and 25 Tide. Weak moves generate Tide, while stronger attacks deliberately spend it and can have round cooldowns. No generic critical hits, items, casual splash HP, or affection rewards are used. At the start of each round there is a 50% chance of public, symmetrical weather: Rain (+20% damage), Drizzle (+15 Tide from builders), Low Tide (+15 Tide costs), Mist (−15 accuracy), or cosmetic Perfect Puddle Weather. The shared duel panel shows HP, Tide, statuses, weather, Rain Dance, Ripple Read availability, lock status, and each player’s last four revealed moves.
...
Gentle Splash has a 15% chance of a random Ripple Effect: self **Foamy** (next incoming hit −25%), opponent **Drenched** (next successful incoming hit +15%), or cosmetic **Waterlogged**. Water Gun has a 20% chance and Aqua Jet a 15% chance to apply Drenched. Bubble Beam has a 25% chance to apply **Soaked**: the next successful outgoing damaging move gets +10% damage, while a miss keeps Soaked. Muddy Water has a 30% chance to apply **Slippery**: the next incoming damaging attack loses 35 percentage points of accuracy, then consumes Slippery. Surf has a 15% chance to apply cosmetic Waterlogged. Water Veil halves same-round incoming damage, rounded down. Rain Dance starts three rounds of symmetrical Rain, giving both players’ damaging moves +15% damage.
